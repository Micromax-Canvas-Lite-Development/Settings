...
.method private forTheOtherCard(Landroid/content/Context;ILandroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :cond_0
    new-instance v7, Lcom/android/settings/ext/OmacpApn;

    move-object/from16 v0, p4

    invoke-direct {v7, p1, v8, v9, v0}, Lcom/android/settings/ext/OmacpApn;-><init>(Landroid/content/Context;ILandroid/net/Uri;Ljava/lang/String;)V

    invoke-virtual {v7}, Lcom/android/settings/ext/OmacpApn;->getExistOmacpId()Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, p1, v0}, Lcom/android/settings/ext/OmacpApn;->insert(Landroid/content/Context;Landroid/content/ContentValues;)J
...
.method private insertAPN(Landroid/content/Context;Landroid/content/ContentValues;Ljava/lang/String;ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v8, Lcom/android/settings/ext/OmacpApn;
    ...
    invoke-direct {v8, p1, v0, v1, v2}, Lcom/android/settings/ext/OmacpApn;-><init>(Landroid/content/Context;ILandroid/net/Uri;Ljava/lang/String;)V

    invoke-virtual {v8}, Lcom/android/settings/ext/OmacpApn;->getExistOmacpId()Ljava/util/ArrayList;
    ...
    iput-boolean v12, p0, Lcom/android/settings/ext/DefaultSettingsMiscExt;->mResult:Z
    ...
    iput-wide v12, p0, Lcom/android/settings/ext/DefaultSettingsMiscExt;->mApnToUseId:J
    ...
    invoke-virtual {v8, p1, v0}, Lcom/android/settings/ext/OmacpApn;->insert(Landroid/content/Context;Landroid/content/ContentValues;)J
    ...
    iput-wide v4, p0, Lcom/android/settings/ext/DefaultSettingsMiscExt;->mApnToUseId:J
...
.method public getApnUserId()J
    ...
    iget-wide v0, p0, Lcom/android/settings/ext/DefaultSettingsMiscExt;->mApnToUseId:J
...
.method public getResult()Z
    ...
    iget-boolean v0, p0, Lcom/android/settings/ext/DefaultSettingsMiscExt;->mResult:Z
...
.method public updateApn(Landroid/content/Context;Landroid/content/ContentValues;Ljava/lang/String;ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p7}, Lcom/android/settings/ext/DefaultSettingsMiscExt;->insertAPN(Landroid/content/Context;Landroid/content/ContentValues;Ljava/lang/String;ILandroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/settings/ext/DefaultSettingsMiscExt;->forTheOtherCard(Landroid/content/Context;ILandroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;)Z
