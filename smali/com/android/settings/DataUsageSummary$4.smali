...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    # invokes: Lcom/android/settings/DataUsageSummary;->updateGeminiSimStatus()V
    ...
    invoke-static {v8}, Lcom/android/settings/DataUsageSummary;->access$400(Lcom/android/settings/DataUsageSummary;)V
    ...
    invoke-virtual {v9}, Lcom/android/settings/DataUsageSummary;->getActivity()Landroid/app/Activity;

    move-result-object v9

    invoke-static {v9}, Lcom/android/settings/DataUsageSummary;->isAirplaneModeOn(Landroid/content/Context;)Z

    move-result v9

    # setter for: Lcom/android/settings/DataUsageSummary;->mIsAirplaneModeOn:Z
    invoke-static {v8, v9}, Lcom/android/settings/DataUsageSummary;->access$902(Lcom/android/settings/DataUsageSummary;Z)Z
    ...
    invoke-static {v8}, Lcom/android/settings/DataUsageSummary;->access$1000(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/NetworkPolicyEditor;
    ...
    invoke-static {v8}, Lcom/android/settings/DataUsageSummary;->access$1100(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/DataUsageSummary$CycleAdapter;
    ...
    invoke-static {v8, v10}, Lcom/android/settings/DataUsageSummary;->access$800(Lcom/android/settings/DataUsageSummary;Z)V
    ...
    invoke-static {}, Lcom/android/settings/DataUsageSummary;->access$1200()Z
    ...
    invoke-static {v8}, Lcom/android/settings/DataUsageSummary;->access$1300(Lcom/android/settings/DataUsageSummary;)Landroid/os/Handler;
    ...
    invoke-static {v12}, Lcom/android/settings/DataUsageSummary;->access$1202(Z)Z

    iget-object v8, p0, Lcom/android/settings/DataUsageSummary$4;->this$0:Lcom/android/settings/DataUsageSummary;

    # getter for: Lcom/android/settings/DataUsageSummary;->mDataEnabled:Landroid/widget/Switch;
    invoke-static {v8}, Lcom/android/settings/DataUsageSummary;->access$1400(Lcom/android/settings/DataUsageSummary;)Landroid/widget/Switch;
    ...
    iget-boolean v8, v8, Lcom/android/settings/DataUsageSummary;->mHaveSim1Tab:Z
    ...
    iget-boolean v8, v8, Lcom/android/settings/DataUsageSummary;->mHaveSim2Tab:Z
    ...
    invoke-static {v8}, Lcom/android/settings/DataUsageSummary;->access$1500(Lcom/android/settings/DataUsageSummary;)V
