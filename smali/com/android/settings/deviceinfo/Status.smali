...
.field private mExt:Lcom/android/settings/ext/IStatusExt;
...
.method static synthetic access$400(Lcom/android/settings/deviceinfo/Status;)Lcom/android/settings/ext/IStatusExt;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/deviceinfo/Status;->mExt:Lcom/android/settings/ext/IStatusExt;
...
.method private updateServiceState(Landroid/telephony/ServiceState;)V
    ...
    iget-object v4, p0, Lcom/android/settings/deviceinfo/Status;->mExt:Lcom/android/settings/ext/IStatusExt;

    invoke-virtual {p1}, Landroid/telephony/ServiceState;->getOperatorAlphaLong()Ljava/lang/String;

    move-result-object v5

    invoke-interface {v4, v2, v5}, Lcom/android/settings/ext/IStatusExt;->updateServiceState(Landroid/preference/Preference;Ljava/lang/String;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, Lcom/android/settings/Utils;->getStatusExtPlugin(Landroid/content/Context;)Lcom/android/settings/ext/IStatusExt;

    move-result-object v7

    iput-object v7, p0, Lcom/android/settings/deviceinfo/Status;->mExt:Lcom/android/settings/ext/IStatusExt;
...
.method protected onResume()V
    ...
    iget-object v2, p0, Lcom/android/settings/deviceinfo/Status;->mExt:Lcom/android/settings/ext/IStatusExt;

    const-string v3, "android.provider.Telephony.SPN_STRINGS_UPDATED"

    invoke-interface {v2, v0, v3}, Lcom/android/settings/ext/IStatusExt;->addAction(Landroid/content/IntentFilter;Ljava/lang/String;)V
