...
.method private dynamicShowDefaultWriteCategory()V
    ...
    iget-object v3, p0, Lcom/android/settings/deviceinfo/Memory;->mDefaultWritePathAdded:[Z

    aget-boolean v3, v3, v0

    if-nez v3, :cond_0

    iget-object v3, p0, Lcom/android/settings/deviceinfo/Memory;->mDefaultWriteCategory:Landroid/preference/PreferenceCategory;
    ...
    invoke-virtual {v3, v6}, Lcom/android/settings/deviceinfo/RadioButtonPreference;->setChecked(Z)Z
    ...
    iput-object v3, p0, Lcom/android/settings/deviceinfo/Memory;->mDefaultWritePath:Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/android/settings/deviceinfo/Memory;->mDefaultWritePath:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/settings/deviceinfo/Memory;->mDefaultWritePath:Ljava/lang/String;
    ...
    invoke-virtual {v3, v7}, Lcom/android/settings/deviceinfo/RadioButtonPreference;->setChecked(Z)Z

    iget-object v3, p0, Lcom/android/settings/deviceinfo/Memory;->mStorageWritePathGroup:[Lcom/android/settings/deviceinfo/RadioButtonPreference;

    aget-object v3, v3, v0

    iput-object v3, p0, Lcom/android/settings/deviceinfo/Memory;->mDeafultWritePathPref:Lcom/android/settings/deviceinfo/RadioButtonPreference;
...
.method private mount()V
    ...
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/Memory;->mIsRemovableVolume:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x3

    invoke-direct {p0, v0}, Lcom/android/settings/deviceinfo/Memory;->showDialogInner(I)V
...
.method public dynamicShowInstallLocation()V
    ...
    invoke-static {}, Lcom/android/settings/deviceinfo/Memory;->isExSdcardInserted()Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/Memory;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mUsbManager:Landroid/hardware/usb/UsbManager;
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mStorageManager:Landroid/os/storage/StorageManager;
    ...
    iget-object v0, v0, Lcom/android/settings/deviceinfo/Memory;->mStorageListener:Landroid/os/storage/StorageEventListener;
    ...
    const v16, 0x7f060011

    move-object/from16 v0, p0

    move/from16 v1, v16

    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/Memory;->addPreferencesFromResource(I)V
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mUiHandler:Landroid/os/Handler;
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mDefaultWriteCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mResources:Landroid/content/res/Resources;
    ...
    iget-object v0, v0, Lcom/android/settings/deviceinfo/Memory;->mDefaultWriteCategory:Landroid/preference/PreferenceCategory;
    ...
    invoke-static {v2}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->buildForInternal(Landroid/content/Context;)Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/deviceinfo/Memory;->addCategory(Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;)V
    ...
    new-array v0, v7, [Lcom/android/settings/deviceinfo/RadioButtonPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mStorageWritePathGroup:[Lcom/android/settings/deviceinfo/RadioButtonPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mDefaultWritePathAdded:[Z
    ...
    iget-object v0, v0, Lcom/android/settings/deviceinfo/Memory;->mStorageWritePathGroup:[Lcom/android/settings/deviceinfo/RadioButtonPreference;

    move-object/from16 v16, v0

    new-instance v17, Lcom/android/settings/deviceinfo/RadioButtonPreference;

    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/deviceinfo/Memory;->getActivity()Landroid/app/Activity;

    move-result-object v18

    invoke-direct/range {v17 .. v18}, Lcom/android/settings/deviceinfo/RadioButtonPreference;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/RadioButtonPreference;->setKey(Ljava/lang/String;)V
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/android/settings/deviceinfo/RadioButtonPreference;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/RadioButtonPreference;->setPath(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/RadioButtonPreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V
    ...
    invoke-static {v2, v13}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->buildForPhysical(Landroid/content/Context;Landroid/os/storage/StorageVolume;)Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/Memory;->setHasOptionsMenu(Z)V
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mApkInstallePref:Landroid/preference/Preference;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/deviceinfo/Memory;->isPkgInstalled(Ljava/lang/String;)Z
    ...
    iput-boolean v0, v1, Lcom/android/settings/deviceinfo/Memory;->mIsApkInstallerExist:Z

    move-object/from16 v0, p0

    iget-boolean v0, v0, Lcom/android/settings/deviceinfo/Memory;->mIsApkInstallerExist:Z
    ...
    iget-object v0, v0, Lcom/android/settings/deviceinfo/Memory;->mApkInstallePref:Landroid/preference/Preference;
    ...
    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mInstallLocation:Landroid/preference/ListPreference;
    ...
    iget-object v0, v0, Lcom/android/settings/deviceinfo/Memory;->mInstallLocation:Landroid/preference/ListPreference;
    ...
    :goto_6
    new-instance v16, Lcom/android/settings/deviceinfo/Memory$3;

    move-object/from16 v0, v16

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/settings/deviceinfo/Memory$3;-><init>(Lcom/android/settings/deviceinfo/Memory;)V

    move-object/from16 v0, v16

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/settings/deviceinfo/Memory;->mHandler:Landroid/os/Handler;
    ...
    iget-object v0, v0, Lcom/android/settings/deviceinfo/Memory;->mDynSwapReceiver:Landroid/content/BroadcastReceiver;
    ...
    new-instance v17, Lcom/android/settings/deviceinfo/Memory$2;

    move-object/from16 v0, v17

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Lcom/android/settings/deviceinfo/Memory$2;-><init>(Lcom/android/settings/deviceinfo/Memory;)V
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/android/settings/deviceinfo/Memory;->mDynSwapReceiver:Landroid/content/BroadcastReceiver;
