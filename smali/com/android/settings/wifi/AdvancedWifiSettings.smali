...
.method private initPreferences()V
    ...
    iget-object v6, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mExt:Lcom/android/settings/ext/IWifiExt;

    invoke-virtual {p0}, Lcom/android/settings/wifi/AdvancedWifiSettings;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v7

    invoke-interface {v6, v7}, Lcom/android/settings/ext/IWifiExt;->getSleepPolicy(Landroid/content/ContentResolver;)I
...
.method private refreshWifiInfo()V
    ...
    invoke-interface {v6}, Lcom/android/settings/ext/IWifiExt;->refreshNetworkInfoView()V
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mExt:Lcom/android/settings/ext/IWifiExt;
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/settings/ext/IWifiExt;->initConnectView(Landroid/app/Activity;Landroid/preference/PreferenceScreen;)V
    ...
    invoke-interface {v0, v1}, Lcom/android/settings/ext/IWifiExt;->initPreference(Landroid/content/ContentResolver;)V
    ...
    invoke-interface {v0, v1}, Lcom/android/settings/ext/IWifiExt;->initNetworkInfoView(Landroid/preference/PreferenceScreen;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Lcom/android/settings/Utils;->getWifiPlugin(Landroid/content/Context;)Lcom/android/settings/ext/IWifiExt;

    move-result-object v0

    iput-object v0, p0, Lcom/android/settings/wifi/AdvancedWifiSettings;->mExt:Lcom/android/settings/ext/IWifiExt;
