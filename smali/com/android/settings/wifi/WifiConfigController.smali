...
.field mExt:Lcom/android/settings/ext/IWifiExt;
...
.method public constructor <init>(Lcom/android/settings/wifi/WifiConfigUiBase;Landroid/view/View;Lcom/android/settings/wifi/AccessPoint;Z)V
    ...
    invoke-static {v6}, Lcom/android/settings/Utils;->getWifiPlugin(Landroid/content/Context;)Lcom/android/settings/ext/IWifiExt;
    ...
    iput-object v0, v1, Lcom/android/settings/wifi/WifiConfigController;->mExt:Lcom/android/settings/ext/IWifiExt;
    ...
    iget-object v0, v0, Lcom/android/settings/wifi/WifiConfigController;->mExt:Lcom/android/settings/ext/IWifiExt;
    ...
    invoke-interface/range {v21 .. v22}, Lcom/android/settings/ext/IWifiExt;->setAPNetworkId(I)V
    ...
    invoke-interface/range {v21 .. v22}, Lcom/android/settings/ext/IWifiExt;->setAPPriority(I)V
    ...
    invoke-interface/range {v21 .. v21}, Lcom/android/settings/ext/IWifiExt;->getPriorityView()Landroid/view/View;
    ...
    invoke-interface {v0, v15}, Lcom/android/settings/ext/IWifiExt;->setSecurityText(Landroid/widget/TextView;)V
    ...
    const v20, 0x7f0a0226

    goto/16 :goto_2

    :cond_9
    const v20, 0x7f0a0225
    ...
    const v23, 0x7f080472

    invoke-interface/range {v22 .. v23}, Lcom/android/settings/ext/IWifiExt;->getSecurityText(I)Ljava/lang/String;
    ...
    invoke-interface/range {v21 .. v23}, Lcom/android/settings/ext/IWifiExt;->shouldAddForgetButton(Ljava/lang/String;I)Z
    ...
    invoke-interface/range {v21 .. v21}, Lcom/android/settings/ext/IWifiExt;->shouldSetDisconnectButton()Z
...
.method private showProxyFields()V
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/WifiConfigController;->mExt:Lcom/android/settings/ext/IWifiExt;

    invoke-interface {v3, v2}, Lcom/android/settings/ext/IWifiExt;->setProxyText(Landroid/widget/TextView;)V
...
.method private showSecurityFields()V
    ...
    iget-boolean v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mInXlSetupWizard:Z
    ...
    invoke-virtual {v5, v6, v7}, Lcom/android/settings/wifi/WifiSettingsForSetupWizardXL;->initSecurityFields(Landroid/view/View;I)Z
    ...
    iget-boolean v6, p0, Lcom/android/settings/wifi/WifiConfigController;->mHex:Z
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mWapiAsCert:Landroid/widget/Spinner;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mWapiClientCert:Landroid/widget/Spinner;
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mWapiClientCert:Landroid/widget/Spinner;
    ...
    invoke-direct {p0, v5, v6}, Lcom/android/settings/wifi/WifiConfigController;->loadCertificates(Landroid/widget/Spinner;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, v6, v7}, Lcom/android/settings/wifi/WifiConfigController;->setCertificate(Landroid/widget/Spinner;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mPasswordView:Landroid/widget/TextView;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mEapMethodSpinner:Landroid/widget/Spinner;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mPhase2Spinner:Landroid/widget/Spinner;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mEapCaCertSpinner:Landroid/widget/Spinner;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mEapUserCertSpinner:Landroid/widget/Spinner;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mEapIdentityView:Landroid/widget/TextView;
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mEapAnonymousView:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v5, v6}, Lcom/android/settings/wifi/WifiConfigController;->setSelection(Landroid/widget/Spinner;Ljava/lang/String;)V
    ...
    iput-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mSimSlot:Landroid/widget/Spinner;
    ...
    iget-object v5, p0, Lcom/android/settings/wifi/WifiConfigController;->mSimSlot:Landroid/widget/Spinner;
    ...
    invoke-direct {p0, v5, v4}, Lcom/android/settings/wifi/WifiConfigController;->setSelection(Landroid/widget/Spinner;Ljava/lang/String;)V
...
.method public closeSpinnerDialog()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/settings/wifi/WifiConfigController;->mExt:Lcom/android/settings/ext/IWifiExt;

    invoke-interface {v0}, Lcom/android/settings/ext/IWifiExt;->closeSpinnerDialog()V
...
.method getConfig()Landroid/net/wifi/WifiConfiguration;
    ...
    :goto_1
    iget-object v7, p0, Lcom/android/settings/wifi/WifiConfigController;->mExt:Lcom/android/settings/ext/IWifiExt;

    invoke-interface {v7}, Lcom/android/settings/ext/IWifiExt;->getPriority()I
    ...
    iget-object v7, p0, Lcom/android/settings/wifi/WifiConfigController;->mSimSlot:Landroid/widget/Spinner;
    ...
    iget-object v7, p0, Lcom/android/settings/wifi/WifiConfigController;->mTelephonyManagerEx:Lcom/mediatek/telephony/TelephonyManagerEx;
    ...
    invoke-static {v7, v8}, Lcom/android/settings/wifi/WifiConfigController;->makeNAI(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
