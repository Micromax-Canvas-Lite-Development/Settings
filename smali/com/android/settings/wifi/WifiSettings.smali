...
.field mExt:Lcom/android/settings/ext/IWifiSettingsExt;
...
.method private addMessagePreference(I)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;

    invoke-virtual {p0}, Lcom/android/settings/wifi/WifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/android/settings/ext/IWifiSettingsExt;->emptyScreen(Landroid/preference/PreferenceScreen;)V
...
.method private constructAccessPoints()Ljava/util/List;
    ...
    new-instance v3, Lcom/android/settings/wifi/WifiSettings$Multimap;

    const/4 v15, 0x0

    move-object/from16 v0, p0

    invoke-direct {v3, v0, v15}, Lcom/android/settings/wifi/WifiSettings$Multimap;-><init>(Lcom/android/settings/wifi/WifiSettings;Lcom/android/settings/wifi/WifiSettings$1;)V

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;
    ...
    invoke-interface/range {v15 .. v16}, Lcom/android/settings/ext/IWifiSettingsExt;->emptyCategory(Landroid/preference/PreferenceScreen;)V

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/settings/wifi/WifiSettings;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    invoke-interface/range {v15 .. v16}, Lcom/android/settings/ext/IWifiSettingsExt;->setLastPriority(I)V
    ...
    invoke-direct {v1, v15, v4}, Lcom/android/settings/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-virtual {v1, v15, v0}, Lcom/android/settings/wifi/AccessPoint;->update(Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo$DetailedState;)V

    invoke-virtual {v2, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v15, v1, Lcom/android/settings/wifi/AccessPoint;->ssid:Ljava/lang/String;

    invoke-virtual {v3, v15, v1}, Lcom/android/settings/wifi/WifiSettings$Multimap;->put(Ljava/lang/Object;Ljava/lang/Object;)V

    move-object/from16 v0, p0

    iget-object v15, v0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;

    invoke-interface {v15}, Lcom/android/settings/ext/IWifiSettingsExt;->isCatogoryExist()Z
    ...
    iget v0, v1, Lcom/android/settings/wifi/AccessPoint;->security:I

    move/from16 v17, v0

    invoke-interface/range {v15 .. v17}, Lcom/android/settings/ext/IWifiSettingsExt;->isTustAP(Ljava/lang/String;I)Z
    ...
    iget-object v15, v0, Lcom/android/settings/wifi/WifiSettings;->mTrustAPCategory:Landroid/preference/PreferenceCategory;
    ...
    invoke-static/range {v16 .. v17}, Lcom/android/settings/wifi/WifiDialog;->makeNAI(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v15, v0, Lcom/android/settings/wifi/WifiSettings;->mTelephonyManagerEx:Lcom/mediatek/telephony/TelephonyManagerEx;
    ...
    invoke-static/range {v15 .. v16}, Lcom/android/settings/wifi/WifiDialog;->makeNAI(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v15, v0, Lcom/android/settings/wifi/WifiSettings;->mConfigedAPCategory:Landroid/preference/PreferenceCategory;
    ...
    invoke-virtual {v3, v15}, Lcom/android/settings/wifi/WifiSettings$Multimap;->getAll(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {v1, v11}, Lcom/android/settings/wifi/AccessPoint;->update(Landroid/net/wifi/ScanResult;)Z
    ...
    invoke-direct {v1, v15, v11}, Lcom/android/settings/wifi/AccessPoint;-><init>(Landroid/content/Context;Landroid/net/wifi/ScanResult;)V
    ...
    iget-object v15, v0, Lcom/android/settings/wifi/WifiSettings;->mNewAPCategory:Landroid/preference/PreferenceCategory;
    ...
    invoke-interface/range {v15 .. v16}, Lcom/android/settings/ext/IWifiSettingsExt;->refreshCategory(Landroid/preference/PreferenceScreen;)V
...
.method private updateAccessPoints()V
    ...
    :cond_2
    iget-object v4, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;

    invoke-interface {v4}, Lcom/android/settings/ext/IWifiSettingsExt;->isCatogoryExist()Z
    ...
    invoke-interface {v4, v5}, Lcom/android/settings/ext/IWifiSettingsExt;->emptyCategory(Landroid/preference/PreferenceScreen;)V
...
.method private updateConnectionState(Landroid/net/NetworkInfo$DetailedState;)V
    ...
    :cond_3
    iget-object v5, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;

    invoke-interface {v5}, Lcom/android/settings/ext/IWifiSettingsExt;->isCatogoryExist()Z
    ...
    invoke-interface {v5, v6}, Lcom/android/settings/ext/IWifiSettingsExt;->updatePriorityAfterConnect(I)V
...
.method private updateWifiState(I)V
    ...
    :cond_1
    iget-object v2, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;

    invoke-interface {v2}, Lcom/android/settings/ext/IWifiSettingsExt;->updatePriority()V
...
.method public addNetworkForSelector()V
    ...
    invoke-interface {v0}, Lcom/android/settings/ext/IWifiSettingsExt;->isCatogoryExist()Z
...
.method forget()V
    ...
    invoke-interface {v0}, Lcom/android/settings/ext/IWifiSettingsExt;->updatePriority()V
...
.method getAccessPointsCount()I
    ...
    iget-object v1, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;

    invoke-virtual {p0}, Lcom/android/settings/wifi/WifiSettings;->getPreferenceScreen()Landroid/preference/PreferenceScreen;

    move-result-object v2

    invoke-interface {v1, v2}, Lcom/android/settings/ext/IWifiSettingsExt;->getAccessPointsCount(Landroid/preference/PreferenceScreen;)I
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    invoke-static {v7}, Lcom/android/settings/Utils;->getWifiSettingsPlugin(Landroid/content/Context;)Lcom/android/settings/ext/IWifiSettingsExt;

    move-result-object v7

    iput-object v7, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;
    ...
    iget-object v7, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;
    ...
    invoke-interface {v7, v8, v9, v10}, Lcom/android/settings/ext/IWifiSettingsExt;->setCategory(Landroid/preference/PreferenceCategory;Landroid/preference/PreferenceCategory;Landroid/preference/PreferenceCategory;)V
    ...
    invoke-interface {v7, v8}, Lcom/android/settings/ext/IWifiSettingsExt;->emptyScreen(Landroid/preference/PreferenceScreen;)V
    ...
    invoke-interface {v7, v8, v9}, Lcom/android/settings/ext/IWifiSettingsExt;->registerPriorityObserver(Landroid/content/ContentResolver;Landroid/content/Context;)V
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-interface {v1, v2}, Lcom/android/settings/ext/IWifiSettingsExt;->disconnect(I)V
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    invoke-interface {v1}, Lcom/android/settings/ext/IWifiSettingsExt;->shouldAddDisconnectMenu()Z
    ...
    invoke-interface {v1, v2, v3}, Lcom/android/settings/ext/IWifiSettingsExt;->shouldAddForgetMenu(Ljava/lang/String;I)Z
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    invoke-interface {v1, v2}, Lcom/android/settings/ext/IWifiSettingsExt;->recordPriority(I)V
...
.method public onDestroy()V
    ...
    invoke-interface {v0, v1}, Lcom/android/settings/ext/IWifiSettingsExt;->unregisterPriorityObserver(Landroid/content/ContentResolver;)V
...
.method refreshAccessPoints()V
    ...
    invoke-interface {v0, v1}, Lcom/android/settings/ext/IWifiSettingsExt;->emptyCategory(Landroid/preference/PreferenceScreen;)V
...
.method submit(Lcom/android/settings/wifi/WifiConfigController;)V
    ...
    :cond_7
    :goto_1
    iget-object v6, p0, Lcom/android/settings/wifi/WifiSettings;->mExt:Lcom/android/settings/ext/IWifiSettingsExt;

    invoke-interface {v6, v0}, Lcom/android/settings/ext/IWifiSettingsExt;->setLastConnectedConfig(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-interface {v6, v7}, Lcom/android/settings/ext/IWifiSettingsExt;->disconnect(I)V
    ...
    invoke-interface {v6, v0}, Lcom/android/settings/ext/IWifiSettingsExt;->setNewPriority(Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-interface {v6, v0}, Lcom/android/settings/ext/IWifiSettingsExt;->updatePriorityAfterSubmit(Landroid/net/wifi/WifiConfiguration;)V
