...
.method private updateLockScreenStyle()V
    ...
    iget-object v5, p0, Lcom/android/settings/DisplaySettings;->mDisplayPerCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v6, p0, Lcom/android/settings/DisplaySettings;->mLockScreenStylePref:Landroid/preference/Preference;
    ...
    invoke-virtual {p0, v5}, Lcom/android/settings/DisplaySettings;->parseString(Ljava/lang/String;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v4}, Lcom/android/settings/Utils;->getMiscPlugin(Landroid/content/Context;)Lcom/android/settings/ext/ISettingsMiscExt;

    move-result-object v4

    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mExt:Lcom/android/settings/ext/ISettingsMiscExt;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mDisplayPerCategory:Landroid/preference/PreferenceCategory;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mDisplayDefCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v4, p0, Lcom/android/settings/DisplaySettings;->mDisplayDefCategory:Landroid/preference/PreferenceCategory;
    ...
    iget-object v4, p0, Lcom/android/settings/DisplaySettings;->mExt:Lcom/android/settings/ext/ISettingsMiscExt;

    iget-object v7, p0, Lcom/android/settings/DisplaySettings;->mScreenTimeoutPreference:Landroid/preference/ListPreference;

    invoke-interface {v4, v7}, Lcom/android/settings/ext/ISettingsMiscExt;->setTimeoutPrefTitle(Landroid/preference/Preference;)V
    ...
    invoke-direct {p0, v4}, Lcom/android/settings/DisplaySettings;->updateFontSize(Landroid/preference/ListPreference;)V
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mLandscapeLauncher:Landroid/preference/ListPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mHDMISettings:Landroid/preference/Preference;

    iget-object v4, p0, Lcom/android/settings/DisplaySettings;->mHDMISettings:Landroid/preference/Preference;
    ...
    iget-object v5, p0, Lcom/android/settings/DisplaySettings;->mHDMISettings:Landroid/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mTVOut:Landroid/preference/Preference;
    ...
    iget-object v5, p0, Lcom/android/settings/DisplaySettings;->mTVOut:Landroid/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mColorPref:Landroid/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mScencePref:Landroid/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mWallpaperPref:Landroid/preference/Preference;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mLockScreenNotifications:Landroid/preference/CheckBoxPreference;

    iget-object v4, p0, Lcom/android/settings/DisplaySettings;->mLockScreenNotifications:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v4, p0, Lcom/android/settings/DisplaySettings;->mLockScreenStylePref:Landroid/preference/Preference;
