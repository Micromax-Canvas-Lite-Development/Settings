...
.field private static sSettingsMiscExt:Lcom/android/settings/ext/ISettingsMiscExt;

.field private static sSimRoamingExt:Lcom/android/settings/ext/ISimRoamingExt;


# instance fields
.field private mAdapter:Lcom/android/settings/DataUsageSummary$DataUsageAdapter;

.field private mAdditionalRemiderView:Landroid/view/View;

.field private mAdditionalReminder:Landroid/widget/Switch;

.field private mAdditionalReminderListener:Landroid/view/View$OnClickListener;

.field private mAdditionalReminderSettings:Landroid/widget/LinearLayout;

.field private mAdditionalReminderSwitchListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
...
.field private mHeaderWl:Landroid/view/ViewGroup;
...
.field private mWhiteListSwitchesContainer:Landroid/view/ViewGroup;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->mIsUserEnabledNoneGemini:Z
    ...
    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim1Tab:Z

    iput-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim2Tab:Z
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderListener:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderSwitchListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
...
.method static synthetic access$1000(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/NetworkPolicyEditor;
    .locals 1
...
.method static synthetic access$1100(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/DataUsageSummary$CycleAdapter;
    .locals 1
...
.method static synthetic access$1600(Lcom/android/settings/DataUsageSummary;)Landroid/net/INetworkStatsService;
    .locals 1
...
.method static synthetic access$1900(Lcom/android/settings/DataUsageSummary;ZI)V
    .locals 0
...
.method static synthetic access$2000(Lcom/android/settings/DataUsageSummary;I)I
    .locals 1
...
.method static synthetic access$2100(Lcom/android/settings/DataUsageSummary;)Lcom/mediatek/CellConnService/CellConnMgr;
    .locals 1
...
.method static synthetic access$2400()Lcom/android/settings/ext/ISimRoamingExt;
    .locals 1

    sget-object v0, Lcom/android/settings/DataUsageSummary;->sSimRoamingExt:Lcom/android/settings/ext/ISimRoamingExt;
...
.method static synthetic access$2700(Lcom/android/settings/DataUsageSummary;)Z
    ...
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->isAdditionalRemiderEnabled()Z
...
.method static synthetic access$2800(Lcom/android/settings/DataUsageSummary;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/settings/DataUsageSummary;->setAdditionalRemiderEnabled(Z)V

    return-void
.end method

.method static synthetic access$2900(Lcom/android/settings/DataUsageSummary;)Landroid/widget/Switch;
    .locals 1

    iget-object v0, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminder:Landroid/widget/Switch;
...
.method static synthetic access$300(Lcom/android/settings/DataUsageSummary;)V
    ...
    invoke-direct {p0}, Lcom/android/settings/DataUsageSummary;->updateGeminiSimStatus()V
...
.method static synthetic access$3300(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/UidDetailProvider;
    .locals 1
...
.method static synthetic access$3400(Lcom/android/settings/DataUsageSummary;)Landroid/widget/Spinner;
    .locals 1
...
.method static synthetic access$3500(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/widget/ChartDataUsageView;
    .locals 1
...
.method static synthetic access$3700(Lcom/android/settings/DataUsageSummary;)Landroid/net/INetworkStatsSession;
    .locals 1
...
.method static synthetic access$3800(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/net/ChartData;
    .locals 1
...
.method static synthetic access$3802(Lcom/android/settings/DataUsageSummary;Lcom/android/settings/net/ChartData;)Lcom/android/settings/net/ChartData;
    .locals 0
...
.method static synthetic access$4000(Lcom/android/settings/DataUsageSummary;)Landroid/widget/ListView;
    .locals 1
...
.method static synthetic access$4100(Lcom/android/settings/DataUsageSummary;)Landroid/net/NetworkPolicyManager;
    .locals 1
...
.method static synthetic access$4200(Lcom/android/settings/DataUsageSummary;)Lcom/android/settings/DataUsageSummary$DataUsageAdapter;
    .locals 1
...
.method static synthetic access$4400(Lcom/android/settings/DataUsageSummary;)Landroid/widget/TextView;
    .locals 1
...
.method static synthetic access$4500(Lcom/android/settings/DataUsageSummary;J)V
    .locals 0
...
.method static synthetic access$4802(Lcom/android/settings/DataUsageSummary;Z)Z
    .locals 0
...
.method static synthetic access$4900(Lcom/android/settings/DataUsageSummary;IZ)V
    .locals 0
...
.method static synthetic access$500(Lcom/android/settings/DataUsageSummary;)Z
    ...
    iget-boolean v0, p0, Lcom/android/settings/DataUsageSummary;->mIsUserEnabledNoneGemini:Z

    return v0
.end method

.method static synthetic access$5000(Lcom/android/settings/DataUsageSummary;IZ)V
    .locals 0
...
.method static synthetic access$502(Lcom/android/settings/DataUsageSummary;Z)Z
    .locals 0

    iput-boolean p1, p0, Lcom/android/settings/DataUsageSummary;->mIsUserEnabledNoneGemini:Z

    return p1
.end method

.method static synthetic access$5100(Lcom/android/settings/DataUsageSummary;Z)V
    .locals 0
...
.method static synthetic access$5200()Lcom/android/settings/ext/ISettingsMiscExt;
    .locals 1

    sget-object v0, Lcom/android/settings/DataUsageSummary;->sSettingsMiscExt:Lcom/android/settings/ext/ISettingsMiscExt;

    return-object v0
.end method

.method static synthetic access$602(Lcom/android/settings/DataUsageSummary;Ljava/lang/Boolean;)Ljava/lang/Boolean;
    .locals 0
...
.method static synthetic access$700(Lcom/android/settings/DataUsageSummary;)Landroid/net/ConnectivityManager;
    .locals 1
...
.method static synthetic access$902(Lcom/android/settings/DataUsageSummary;Z)Z
    .locals 0
...
.method private buildLimitedNetworksList()Ljava/util/List;
    ...
    iget-boolean v4, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim1Tab:Z
    ...
    invoke-static {v5}, Lcom/android/settings/DataUsageSummary;->getSubscriberId(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/DataUsageSummary;->getText(I)Ljava/lang/CharSequence;
    ...
    :cond_0
    iget-boolean v4, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim2Tab:Z
...
.method private computeTabFromIntent(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/android/settings/DataUsageSummary;->getSubscriberId(I)Ljava/lang/String;
...
.method private inflateLockScreenView(Landroid/view/LayoutInflater;)V
    ...
    new-instance v1, Lcom/android/settings/DataUsageSummary$20;

    invoke-direct {v1, p0}, Lcom/android/settings/DataUsageSummary$20;-><init>(Lcom/android/settings/DataUsageSummary;)V
...
.method private isAdditionalRemiderEnabled()Z
    .locals 1

    invoke-static {p0}, Lcom/android/settings/AdditionalDataPlanFragment;->isEnabled(Landroid/app/Fragment;)Z
...
.method private isSimStatusNotReady(Ljava/lang/String;)Z
    ...
    iget v3, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus1:I
    ...
    iget v3, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus2:I
...
.method public static isSupportAcerDtm()Z
    .locals 6
    ...
    const-string v4, "isSupportAcerDtm="

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v0, "acer.app.dtm"
...
.method private setAdditionalRemiderEnabled(Z)V
    .locals 2

    const-string v0, "DataUsage"

    const-string v1, "setAdditionalRemiderEnabled()"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-static {p0, p1}, Lcom/android/settings/AdditionalDataPlanFragment;->setEnabled(Landroid/app/Fragment;Z)V
...
.method private updateAppDetail()V
    ...
    sget-object v18, Lcom/android/settings/DataUsageSummary;->sSettingsMiscExt:Lcom/android/settings/ext/ISettingsMiscExt;

    const v19, 0x7f0808c1
    ...
    invoke-interface/range {v18 .. v20}, Lcom/android/settings/ext/ISettingsMiscExt;->getDataUsageBackgroundStrByTag(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private updateBody()V
    ...
    iget-boolean v7, p0, Lcom/android/settings/DataUsageSummary;->mIsAirplaneModeOn:Z

    if-nez v7, :cond_6

    iget v7, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus1:I
    ...
    sget-boolean v8, Lcom/android/settings/DataUsageSummary;->sIsSwitching:Z
    ...
    invoke-static {v6}, Lcom/android/settings/DataUsageSummary;->getSubscriberId(I)Ljava/lang/String;
    ...
    invoke-static {}, Lcom/android/settings/DataUsageSummary;->isSupportAcerDtm()Z

    move-result v5

    if-eqz v5, :cond_7

    invoke-virtual {p0}, Lcom/android/settings/DataUsageSummary;->updateBodyDtm()V
    ...
    iget v7, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus2:I
    ...
    :goto_7
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mDataEnabled:Landroid/widget/Switch;

    sget-boolean v7, Lcom/android/settings/DataUsageSummary;->sIsSwitching:Z
    ...
    invoke-static {v5, v11}, Lcom/android/settings/DataUsageSummary;->setPreferenceTitle(Landroid/view/View;I)V

    invoke-virtual {p0}, Lcom/android/settings/DataUsageSummary;->getActivity()Landroid/app/Activity;

    move-result-object v5

    invoke-static {v5}, Lcom/android/settings/DataUsageSummary;->isAirplaneModeOn(Landroid/content/Context;)Z
    ...
    invoke-static {v5, v12}, Lcom/android/settings/DataUsageSummary;->setPreferenceTitle(Landroid/view/View;I)V
...
.method private updateGeminiSimStatus()V
    ...
    iput-object v2, p0, Lcom/android/settings/DataUsageSummary;->mSimList:Ljava/util/List;

    iput-boolean v4, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim1Tab:Z

    iput-boolean v4, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim2Tab:Z

    iget-object v2, p0, Lcom/android/settings/DataUsageSummary;->mSimList:Ljava/util/List;
    ...
    iput-boolean v6, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim1Tab:Z
    ...
    iput v2, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus1:I
    ...
    iget v4, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus1:I
    ...
    iput-boolean v6, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim2Tab:Z
    ...
    iput v2, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus2:I
    ...
    iget v4, p0, Lcom/android/settings/DataUsageSummary;->mSimStatus2:I
...
.method private updateLockScreenViewState(Landroid/net/NetworkTemplate;Ljava/lang/String;)V
    ...
    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mShowOnLockScreenView:Landroid/view/View;

    if-eqz v5, :cond_0

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mLockScreenEnabled:Landroid/widget/Switch;
    ...
    invoke-virtual {v5, p1}, Lcom/android/settings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->mLockScreenEnabled:Landroid/widget/Switch;
    ...
    iget-object v3, p0, Lcom/android/settings/DataUsageSummary;->mLockScreenPrefTitle:Landroid/widget/TextView;
    ...
    iget-boolean v3, p0, Lcom/android/settings/DataUsageSummary;->mIsLimitChangeToChecked:Z
    ...
    iput-boolean v7, p0, Lcom/android/settings/DataUsageSummary;->mIsLimitChangeToChecked:Z
...
.method private updatePolicy(Z)V
    ...
    invoke-direct {p0, v2}, Lcom/android/settings/DataUsageSummary;->isMobileDataEnabled(I)Z

    move-result v1

    if-nez v1, :cond_4

    iget-boolean v1, p0, Lcom/android/settings/DataUsageSummary;->mIsUserEnabled:Z
    ...
    invoke-direct {p0, v3}, Lcom/android/settings/DataUsageSummary;->isMobileDataEnabled(I)Z
    ...
    invoke-virtual {v1, v0}, Lcom/android/settings/net/NetworkPolicyEditor;->setPolicyActive(Landroid/net/NetworkPolicy;)V
    ...
    invoke-virtual {p0}, Lcom/android/settings/DataUsageSummary;->updatePolicyDtm()V
...
.method private updateTabs()V
    ...
    :cond_4
    iget-boolean v7, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim1Tab:Z
    ...
    iput-object v7, p0, Lcom/android/settings/DataUsageSummary;->mSim1Name:Ljava/lang/String;

    :cond_5
    iget-boolean v7, p0, Lcom/android/settings/DataUsageSummary;->mHaveSim2Tab:Z
    ...
    iput-object v7, p0, Lcom/android/settings/DataUsageSummary;->mSim2Name:Ljava/lang/String;
    ...
    :cond_a
    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mSavedCurrentTab:Ljava/lang/String;
    ...
    :cond_b
    iput-object v10, p0, Lcom/android/settings/DataUsageSummary;->mSavedCurrentTab:Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v3, v4, v5}, Lcom/android/settings/net/NetworkPolicyEditor;-><init>(Landroid/content/Context;Landroid/net/NetworkPolicyManager;)V
    ...
    invoke-static {v3}, Lcom/android/settings/Utils;->getSimRoamingExtPlugin(Landroid/content/Context;)Lcom/android/settings/ext/ISimRoamingExt;

    move-result-object v3

    sput-object v3, Lcom/android/settings/DataUsageSummary;->sSimRoamingExt:Lcom/android/settings/ext/ISimRoamingExt;

    invoke-virtual {p0}, Lcom/android/settings/DataUsageSummary;->getActivity()Landroid/app/Activity;

    move-result-object v3

    invoke-static {v3}, Lcom/android/settings/Utils;->getMiscPlugin(Landroid/content/Context;)Lcom/android/settings/ext/ISettingsMiscExt;

    move-result-object v3

    sput-object v3, Lcom/android/settings/DataUsageSummary;->sSettingsMiscExt:Lcom/android/settings/ext/ISettingsMiscExt;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    new-instance v5, Lcom/mediatek/datausage/OverViewTabAdapter;

    invoke-virtual {p0}, Lcom/android/settings/DataUsageSummary;->getActivity()Landroid/app/Activity;

    move-result-object v8

    iget-object v9, p0, Lcom/android/settings/DataUsageSummary;->mStatsSession:Landroid/net/INetworkStatsSession;

    invoke-direct {v5, v8, v9}, Lcom/mediatek/datausage/OverViewTabAdapter;-><init>(Landroid/content/Context;Landroid/net/INetworkStatsSession;)V

    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mOverviewAdapter:Lcom/mediatek/datausage/OverViewTabAdapter;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mHeaderWl:Landroid/view/ViewGroup;

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mHeaderWl:Landroid/view/ViewGroup;
    ...
    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mOverViewExpList:Landroid/widget/ExpandableListView;

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mOverViewExpList:Landroid/widget/ExpandableListView;

    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mOverviewAdapter:Lcom/mediatek/datausage/OverViewTabAdapter;

    invoke-virtual {v5, v8}, Landroid/widget/ExpandableListView;->setAdapter(Landroid/widget/ExpandableListAdapter;)V
    ...
    invoke-virtual {v5, v8, v10, v6}, Landroid/widget/ListView;->addHeaderView(Landroid/view/View;Ljava/lang/Object;Z)V
    ...
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mHeaderWl:Landroid/view/ViewGroup;
    ...
    invoke-static {v5, v8}, Lcom/android/settings/DataUsageSummary;->insetListViewDrawables(Landroid/widget/ListView;I)V
    ...
    invoke-virtual {v5, v8, v7, v9, v7}, Landroid/view/ViewGroup;->setPadding(IIII)V
    ...
    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mDataEnabled:Landroid/widget/Switch;

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mNetworkSwitches:Landroid/widget/LinearLayout;

    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mDataEnabled:Landroid/widget/Switch;

    invoke-static {p1, v5, v8}, Lcom/android/settings/DataUsageSummary;->inflatePreference(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View;)Landroid/view/View;
    ...
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mDataEnabledListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mWhiteListSwitchesContainer:Landroid/view/ViewGroup;
    ...
    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderSettings:Landroid/widget/LinearLayout;
    ...
    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminder:Landroid/widget/Switch;

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminder:Landroid/widget/Switch;

    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderSwitchListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;

    invoke-virtual {v5, v8}, Landroid/widget/Switch;->setOnCheckedChangeListener(Landroid/widget/CompoundButton$OnCheckedChangeListener;)V

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderSettings:Landroid/widget/LinearLayout;

    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminder:Landroid/widget/Switch;

    invoke-static {p1, v5, v8}, Lcom/android/settings/DataUsageSummary;->inflatePreference(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View;)Landroid/view/View;

    move-result-object v5

    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalRemiderView:Landroid/view/View;

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalRemiderView:Landroid/view/View;

    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderListener:Landroid/view/View$OnClickListener;

    invoke-virtual {v5, v8}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderSettings:Landroid/widget/LinearLayout;

    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalRemiderView:Landroid/view/View;
    ...
    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mCycleAdapterSim1:Lcom/android/settings/DataUsageSummary$CycleAdapter;

    new-instance v5, Lcom/android/settings/DataUsageSummary$CycleAdapter;

    invoke-direct {v5, v0}, Lcom/android/settings/DataUsageSummary$CycleAdapter;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mCycleAdapterSim2:Lcom/android/settings/DataUsageSummary$CycleAdapter;

    new-instance v5, Lcom/android/settings/DataUsageSummary$CycleAdapter;

    invoke-direct {v5, v0}, Lcom/android/settings/DataUsageSummary$CycleAdapter;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/android/settings/DataUsageSummary;->mCycleAdapterOther:Lcom/android/settings/DataUsageSummary$CycleAdapter;
    ...
    invoke-virtual {v5, v8}, Lcom/android/settings/widget/ChartDataUsageView;->setListener(Lcom/android/settings/widget/ChartDataUsageView$DataUsageChartListener;)V

    iget-object v5, p0, Lcom/android/settings/DataUsageSummary;->mChart:Lcom/android/settings/widget/ChartDataUsageView;

    invoke-virtual {v5, v10}, Lcom/android/settings/widget/ChartDataUsageView;->bindNetworkPolicy(Landroid/net/NetworkPolicy;)V
    ...
    iget-object v8, p0, Lcom/android/settings/DataUsageSummary;->mAppSettingsListener:Landroid/view/View$OnClickListener;
    ...
    invoke-static {p1, v5, v7}, Lcom/android/settings/DataUsageSummary;->inflatePreference(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View;)Landroid/view/View;
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)V
    ...
    const-string v17, "DataUsage"

    const-string v18, "onPrepareOptionsMenu()"
    ...
    sget-object v17, Lcom/android/settings/DataUsageSummary;->sSettingsMiscExt:Lcom/android/settings/ext/ISettingsMiscExt;

    const v18, 0x7f0808c1
    ...
    const-string v19, "bgDataSwitch"

    invoke-interface/range {v17 .. v19}, Lcom/android/settings/ext/ISettingsMiscExt;->getDataUsageBackgroundStrByTag(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-boolean v17, Lcom/android/settings/DataUsageSummary;->sIsWifiOnly:Z
    ...
    invoke-interface/range {v16 .. v17}, Landroid/view/MenuItem;->setChecked(Z)Landroid/view/MenuItem;

    const v17, 0x7f0a028b
    ...
    invoke-static {v3, v5, v6}, Lcom/android/settings/HelpUtils;->prepareHelpMenuItem(Landroid/content/Context;Landroid/view/MenuItem;Ljava/lang/String;)Z
    ...
    invoke-static {v0, v15}, Landroid/provider/Telephony$SIMInfo;->getSIMInfoBySlot(Landroid/content/Context;I)Landroid/provider/Telephony$SIMInfo;
    ...
    iget-object v11, v14, Landroid/provider/Telephony$SIMInfo;->mDisplayName:Ljava/lang/String;
    ...
    invoke-interface/range {v17 .. v18}, Landroid/view/MenuItem;->setTitle(Ljava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-direct {v0, v15}, Lcom/android/settings/DataUsageSummary;->getDataRoaming(I)Z
...
.method public onResume()V
    ...
    invoke-static {v1}, Lcom/android/settings/DataUsageSummary;->isAirplaneModeOn(Landroid/content/Context;)Z
...
.method updateBodyDtm()V
    ...
    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalRemiderView:Landroid/view/View;
    ...
    iget-object v6, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalReminderSwitchListener:Landroid/widget/CompoundButton$OnCheckedChangeListener;

    invoke-static {v6}, Lcom/android/settings/AdditionalDataPlanFragment;->setToggleEnabledListener(Landroid/widget/CompoundButton$OnCheckedChangeListener;)V

    invoke-static {p0}, Lcom/android/settings/AdditionalDataPlanFragment;->getCurrentMode(Landroid/app/Fragment;)I
    ...
    :cond_1
    :goto_1
    invoke-static {p0, v2}, Lcom/android/settings/AdditionalDataPlanFragment;->getWarningFlow(Landroid/app/Fragment;I)J
    ...
    invoke-virtual {p0, v6, v7}, Lcom/android/settings/DataUsageSummary;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :goto_2
    invoke-static {v6, v5}, Lcom/android/settings/DataUsageSummary;->setPreferenceSummary(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method updatePolicyDtm()V
    ...
    invoke-virtual {v1, v2}, Lcom/android/settings/net/NetworkPolicyEditor;->getPolicy(Landroid/net/NetworkTemplate;)Landroid/net/NetworkPolicy;
    ...
    iget-object v1, p0, Lcom/android/settings/DataUsageSummary;->mAdditionalRemiderView:Landroid/view/View;
